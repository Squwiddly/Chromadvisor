...
def test_display_molecule_2d():
    ...
    with patch('functions.Chem.MolFromSmiles') as mock_MolFromSmiles, \
         patch('functions.Draw.MolToImage') as mock_MolToImage, \
         patch('functions.ImageTk.PhotoImage') as mock_PhotoImage, \
         patch('functions.ttk.Label') as mock_Label:
